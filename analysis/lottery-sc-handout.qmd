...
2.  [`augsynth`](https://github.com/ebenmichael/augsynth), which additionally allows for Augmented SC (to be discussed later).
...
# install.packages(c("tidysynth","augsynth"))
