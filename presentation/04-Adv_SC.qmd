...
2.  Fit outcome model (e.g., ridge regression) to control data
3.  Get model estimates for all units post-treatment outcomes
4.  Find discrepancy between model estimate for treated unit and model estimate for synthetic unit
...
-   Can still express as weights of control units, but negative weights now allowed; generally less sparse
:::
