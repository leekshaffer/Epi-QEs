---
title: "Quasi-experiments in epidemiology: Difference-in-differences, synthetic control and staggered adoption designs"
...
::: {.fragment .fade-in-then-semi-out}
[9:15--9:30]{style="color: purple"} Analysis 1: DID of zika impacts
:::
...
::: {.fragment .fade-in-then-semi-out}
[11:00--11:30]{style="color: purple"} Analysis 3: SC of Ohio's COVID-19 vaccine lottery
:::
...
::: {.fragment .fade-in-then-semi-out}
[12:00--12:20]{style="color: purple"} Analysis 4: Advanced SC of multiple states' COVID-19 vaccine lotteries
:::
