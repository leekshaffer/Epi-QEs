...
::: callout-note
Synthetic control can accommodate non-parallel trends
:::
...
## Panel Data/Comparative Case Study Setting
...
Find a weighted average of the control units that **best approximates** the pre-treatment history of the treated unit(s). This is the **synthetic control** unit, which is then compared to the treated unit's outcomes in the post-treatment period.
...
[![](images/SC/Abadie2021cite.png){fig-alt="Title of Abadie (2021)" fig-align="center" width="500" height="150"}](https://doi.org/10.1257/jel.20191450)
...
[![Abadie et al. (2010), Figure 3](images/SC/Abadie2010Fig3.png){fig-align="center"}](http://dx.doi.org/10.1198/jasa.2009.ap08746)
...
[![Abadie et al. (2010), Table 1](images/SC/Abadie2010Tbl1.png){fig-align="center"}](http://dx.doi.org/10.1198/jasa.2009.ap08746)
...
::: callout-note
This is related to the cross-validation approach for covariate weight selection, and both should not be used without caution.
:::
...
-   Consider trade-offs: more vs. fewer units, more vs. fewer time periods, etc.
