...
ggplot(data=lang_0912,
  ...
  scale_alpha_manual(name=NULL, breaks=c("Maine","New Mexico","Ohio",
                                         "Other Lottery State",
                                         "Non-Lottery State"),
                     values=c(1,1,1,0.8,0.5)) + 
  scale_linewidth_manual(name=NULL, breaks=c("Maine","New Mexico","Ohio",
                                         "Other Lottery State",
                                         "Non-Lottery State"),
...
[![](images/Adv_SC/BM2021-1cite.png){fig-alt="Title of Ben-Michael et al., J Am Stat Assoc (2021)" fig-align="center"}](https://doi.org/10.1080/01621459.2021.1929245)
...
[![](images/Adv_SC/BM2021-2cite.png){fig-alt="Title of Ben-Michael et al., JRSS B (2021)" fig-align="center"}](https://doi.org/10.1111/rssb.12448)
