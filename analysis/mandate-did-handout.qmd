...
If you install the `DIDmultiplegtDYN` package, a faster implementation of standard errors and more standard interface is available through the `did_multiplegtDYN` function:

```{r}
## Use the following lines to run with DIDmultiplegtDYN package:
