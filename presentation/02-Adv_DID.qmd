...
(1) Restricting Observations: Exclude timing-only comparisons
(2) Restricting Periods: First Difference
...
## 3. Dynamic Regression Specification
...
## 3. Interaction-Weighting Dynamics
...
Various methods use this approach (e.g., [Sun and Abraham (2021)](https://doi.org/10.1016/j.jeconom.2020.09.006)), and differ in which comparisons/observations they allow and how they combine results (SA focuses on time-on-treatment averaging). This implies different assumptions and bias-variance tradeoffs.

## 4. Weighting: Group-Time ATT
...
## 4. Weighting: Callaway and Sant'Anna
...
## 4. Weighting: Stacked DID Regression
...
This essentially estimates each $ATT_{g,t}$ and then inverse-variance weights them through OLS. May have good efficiency, but limits interpretability of estimand.

## 4. Weighting: 2x2 Building Blocks
