...
If you were able to install the `DIDmultiplegtDYN` package, a faster analytical implementation of standard errors is available through the `did_multiplegtDYN` function.
