...
::: {.column width="50%"}
[![Abadie et al. (2010), Table 2](images/SC/Abadie2010Tbl2.png){fig-alt="Table showing the weights for the synthetic California. The only non-zero weights are Colorado (0.164), Connecticut (0.069), Montana (0.199), Nevada (0.234), and Utah (0.334)" fig-align="right"}](https://doi.org/10.1198/jasa.2009.ap08746)
:::
:::
