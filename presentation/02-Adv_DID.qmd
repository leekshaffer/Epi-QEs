...
$$
ATT(a,t) = E[Y_{it}(a) - Y_{it}(0)],
$$

the group-time ATT in period $t$ for a unit first treated in period $a$, compared to if it had never been treated (or not yet treated by period $t$).
...
TWFE assumes \$ATT(a,t) = \theta\$ for all $a \le t$.
