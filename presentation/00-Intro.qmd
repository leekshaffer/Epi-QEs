---
title: "Quasi-experiments in epidemiology: DID, SC, and staggered adoption"
...
::: {.fragment .fade-in-then-semi-out}
[9:15--9:40]{style="color: purple"} Analysis 1: DID of zika impacts
:::

::: {.fragment .fade-in-then-semi-out}
[9:40--10:05]{style="color: purple"} Advanced DID and staggered adoption
:::

::: {.fragment .fade-in-then-semi-out}
[10:05--10:30]{style="color: purple"} Analysis 2: Advanced DID of COVID-19 vaccine mandates
:::

## Workshop Plan: Part II

::: {.fragment .fade-in-then-semi-out}
[10:35--11:00]{style="color: purple"} Introduction to synthetic control
:::
...
::: {.fragment .fade-in-then-semi-out}
[11:30--11:55]{style="color: purple"} Advanced SC methods
:::

::: {.fragment .fade-in-then-semi-out}
[11:55--12:20]{style="color: purple"} Analysis 4: Advanced SC of multiple states' COVID-19 vaccine lotteries
:::
